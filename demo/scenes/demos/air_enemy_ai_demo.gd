...
var _enemy_class = preload("res://scenes/enemies/air_enemy.tscn")
var _smoke_animation_class = preload("res://scenes/etc/smoke_animation.tscn")


onready var _enemy_spawn_position = $EnemyParent/AirEnemy.global_position


func _on_AirEnemy_died(dying_enemy: Node):
	...
	enemy.connect("died", self, "_on_AirEnemy_died")
